...
GMenu2X::GMenu2X() {
	...
	SDL_ShowCursor(0);
	s->ScreenSurface = SDL_SetVideoMode(320, 240, confInt["videoBpp"], SDL_SWSURFACE | SDL_DOUBLEBUF);
	s->raw = SDL_CreateRGBSurface(SDL_SWSURFACE, resX, resY, confInt["videoBpp"], 0, 0, 0, 0);
#else
...
void GMenu2X::readConfig() {
	...
	evalIntConf( &confInt["cpuMax"], 642, 200, 1536 );
	evalIntConf( &confInt["cpuMin"], 342, 6, 1536 );
	evalIntConf( &confInt["cpuMenu"], 600, 200, 1536 );
